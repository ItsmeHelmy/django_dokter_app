...
from dokter_management_app.models import Courses, SessionYearModel

class DateInput(forms.DateInput):
    input_type = "date"

class AddDokterForm(forms.Form):
    ...
    course_id = forms.ChoiceField(label="Jadwal Jaga", choices=course_list, widget=forms.Select(attrs={"class":"form-control"}))
    gender = forms.ChoiceField(label="Gender", choices=gender_list, widget=forms.Select(attrs={"class":"form-control"}))
    jabatan = forms.ChoiceField(label="Jabatan", choices=jabatan_list, widget=forms.Select(attrs={"class":"form-control"}))
    mulai_kerja = forms.DateField(label="Tanggal diterima", widget=DateInput(attrs={"class":"form-control"}))
    ...
    # class Meta:
    #     model = Dokters
    #     fields = ['email', 'password', 'first_name', 'last_name', 'username', 'address', 'besar_honor', 'gender', 'jabatan', 'mulai_kerja', 'session_year_id', 'courses', 'profile_pic']
    #     widgets = {
